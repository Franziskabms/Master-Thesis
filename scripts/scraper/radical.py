...
# --- Sitemap-Index ---
SITEMAP_INDEX = "https://radical.vc/sitemap_index.xml"

RELEVANT_SITEMAPS = {
    "https://radical.vc/post-sitemap.xml",
    "https://radical.vc/founderstories-sitemap.xml",
    "https://radical.vc/series-sitemap.xml",
}

CATEGORY_PAGES = []  # Radical no relevant Archive Sites
