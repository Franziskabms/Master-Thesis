...
# --- Sitemap-Index ---
SITEMAP_INDEX = "https://www.balderton.com/sitemap.xml"

RELEVANT_SITEMAPS = {
    "https://www.balderton.com/post-sitemap.xml",
    "https://www.balderton.com/resource-sitemap.xml",
}
...
def build_url_list() -> list[str]:
    ...
    all_urls = {u for u in all_urls if not any(x in u for x in [
        ...
        "/founder/", "/location/", "/sector/", "/wp-content/",
